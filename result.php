                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <form class="navbar-search" role="search">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Enter Your Roll Here..">
                                            <div class="input-group-btn">
                                                <button type="button" class="btn btn-search btn-info btn-result-search"> <span class="glyphicon glyphicon-search"></span> <span class="label-icon">Search</span> </button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
